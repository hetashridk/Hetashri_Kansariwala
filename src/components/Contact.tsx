...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 px-4 bg-card/30">
          ...
          >
            <div className="glass-card p-8 rounded-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" size="lg" className="w-full bg-primary hover:bg-primary/90" disabled={isSending}>
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="p-4 rounded-lg bg-primary/10 text-primary hover:bg-primary hover:text-white transition-all transform hover:scale-110"
